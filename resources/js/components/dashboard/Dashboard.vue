...
const totalProducts = computed(() => {
    return Number(stats.value.total_products || 0);
});

// in stock

const inStock = computed(() => {
    return Number(stats.value.in_stock || 0);
});

// out of stock

const outOfStock = computed(() => {
    return Number(stats.value.out_of_stock || 0);
});

// total quantity

const totalQuantity = computed(() => {
    return Number(stats.value.total_quantity || 0);
});

// inventory value

const inventoryValue = computed(() => {
    return Number(stats.value.total_inventory_value || 0);
});
    ...
    <div class="mx-auto w-full max-w-7xl px-3 py-4 sm:px-4 sm:py-6 lg:px-6">
        ...
        >
            ...
            >
                ...
                <p class="mt-4 text-xs font-medium text-gray-500 sm:text-sm">
                    Total Products
                </p>
            ...
            >
                ...
                <div class="mt-1 flex items-end gap-2">
                    ...
                    <span class="mb-1 text-xs font-semibold text-green-600">
                        {{ inStockPercentage }}%
                    </span>
                </div>
            </div>
            ...
            >
                ...
                <div class="mt-1 flex items-end gap-2">
                    ...
                    <span class="mb-1 text-xs font-semibold text-red-600">
