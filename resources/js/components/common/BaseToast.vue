    ...
    >
        ...
        >
            <div
                ...
                :key="toast.id"
                class="pointer-events-auto flex w-full items-start gap-3 rounded-xl border border-gray-200 bg-white p-4 text-gray-900 shadow-lg shadow-gray-200/50 transition-colors duration-200 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 dark:shadow-black/20"
            >
                <!-- Icon -->
                ...
                <div class="min-w-0 flex-1 pt-0.5">
                    ...
                    <p
                        class="mt-0.5 text-sm leading-5 text-gray-600 dark:text-gray-300"
                    >
                        {{ toast.message }}
                    </p>
                </div>
                ...
                <button
                    type="button"
                    class="shrink-0 rounded-lg p-1 text-gray-400 transition hover:bg-gray-100 hover:text-gray-700 dark:text-gray-500 dark:hover:bg-gray-800 dark:hover:text-gray-200"
