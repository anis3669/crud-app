        ...
        <form
            ...
            <div class="mb-6">
                ...
                <textarea
                    ...
                    class="w-full resize-none rounded-lg border {{ $errors->has('description') ? 'border-red-400 focus:border-red-500 focus:ring-red-500/10' : 'border-gray-300 focus:border-gray-900 focus:ring-gray-900/10' }} px-4 py-2.5 text-sm outline-none transition focus:ring-2">{{ old('description', $product->description) }}</textarea>
                    ...
                    <p class="mt-2 flex items-center gap-1.5 text-sm text-red-600">
                        ...
                        <svg
                            ...
                            <path
                                ...
                                stroke-linejoin="round"
                                stroke-width="2"
                                d="M12 8v4m0 4h.01M10.29 3.86l-7.82 13.5A2 2 0 004.2 20h15.6a2 2 0 001.73-2.64l-7.82-13.5a2 2 0 001.73-2.64l-7.82-13.5a2 2 0 00-3.46 0z" />
                        </svg>
